                ...
                <div class="row">
                    ...
                    @endif
                        ...
                        @if(empty($currentPost))
                            ...
                            <div class="col-md-4">
                                <div class="thumbnail">
                                    <img src="{{ url($posts[2]['images'][0]) }}" alt="...">
                                    <div class="caption">
                                        <h4>{{ $posts[2]['title'] }}</h4>
                                        <p class="small-font">{{ $posts[2]['summary'] }}</p>
                                        <p><a href="{{ route(strtolower($pages[0]['title'])).'/'.$posts[2]['slug'] }}" class="btn btn-primary btn-xs" role="button">See More</a></p>
                                    </div>
                                </div>
                            </div>
                        @endif
                    ...
                    <div class="last-news">
                        ...
                        @foreach($lastPosts as $col)
                            <div class="col-md-4">
                                <ul>
                                    @foreach($col as $item)
                                        <li><a href="{{ route('news').'/'.str_slug($item, '_') }}">{{ $item }}</a></li>
                                    @endforeach
                                </ul>
                            </div>
                        @endforeach
